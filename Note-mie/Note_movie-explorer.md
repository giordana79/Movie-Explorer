...
Una volta eseguito con npm start si dovrebbero vedere i risultati (fino a 10) e potere navigare tra le pagine con Prev/Next.Nel select del genere, si può scegliere un genere per filtrare i risultati. Si può  cliccare su un titolo e appare il modal animato con i dettagli,cliccare su ❤ per aggiungere ai preferiti e verificare che compaia nella sezione Preferiti.Infine è possibile cambiare tema con il bottone (🌞/🌙) e ricaricare la pagina: il tema dovrebbe persistere.
